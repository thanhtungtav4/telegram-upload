        ...
        switch ($type) {
            ...
            default: // all
                ...
                $sql = "SELECT a.*, f.file_name, u.display_name 
                        ...
                        ORDER BY a.download_time DESC";
                // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared -- No user input, table names from class properties
                ...
                <table class="tg-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo esc_html(self::format_bytes($file->file_size)); ?></td>
                            <td><span class="tg-badge tg-badge-success"><?php echo esc_html(number_format($file->download_count)); ?></span></td>
                            <td><span class="tg-badge tg-badge-info"><?php echo esc_html(number_format($file->analytics_downloads)); ?></span></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
                ...
                <table class="tg-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="tg-badge tg-badge-success"><?php echo esc_html(number_format($user->downloads)); ?></span></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
